---
title: "Near Redundancy and Practical non-identifiability: Leukemia data"
...
This document presents an analysis of Near Redundancy and Practical non-identifiability using the Leukemia data set from the R package `spBayesSurv`. For more information see @rubio:2019 and @rubio:2023.
